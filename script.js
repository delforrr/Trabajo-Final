...
var formulario_inicio_registro = document.querySelector(".formulario_inicio-registro");
var formulario__inicio = document.querySelector(".formulario_inicio");
var formulario__registro = document.querySelector(".formulario_registro");
var apartado_inicio = document.querySelector(".apartado-inicio");
var apartado_registro = document.querySelector(".apartado-registro");
